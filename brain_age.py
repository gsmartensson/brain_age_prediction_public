...
parser.add_argument('--model-dir', type=str,default='/home/gustav/Desktop/misc/brain_age/model_dir_new_norm', help='Path to directory containing the folders trained network weights')
