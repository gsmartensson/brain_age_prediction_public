...
parser.add_argument('--model-dir', type=str,default='/home/gustav/Desktop/misc/brain_age/model_dir_new', help='Path to directory containing the folders trained network weights')
parser.add_argument('--input-file', default='/home/gustav/Desktop/misc/brain_age/test_images/2819307f-b11d-4a5a-93f8-eb094b0de744.nii.gz', help='Absoulute path to the input MRI file in (file assumed to be in .nii or .nii.gz format)')
